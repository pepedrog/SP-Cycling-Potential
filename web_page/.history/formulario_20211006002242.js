...
function already_evalued(trip_id) {
...
function redirect_final() {
    ...
    window.location.href = endereco.substr(0, index) + "mac0499/formulario_fim.html"
}

function submit_form() {
    var link = "mailto:gigeck.pedro@usp.br"
        + "&subject=" + encodeURIComponent("Resposta formulário")
        + "&body=" + encodeURIComponent("teste formulario")
