                    ...
                    <div class="pagina" id="pagina_1">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p>Essa pesquisa visa auxiliar o planejamento de políticas públicas para investimentos
                                    em infraestrutura cicloviária. Visamos estudar quais são os locais da cidade que
                                    mais se
                                    beneficiariam da construção de ciclovias ou ciclofaixas, por terem características
                                    físicas
                                    (distância, topografia) apropriadas para o uso de bicicleta.
                                </p>
                                <p>
                                    Você avaliará 5 ou 10 rotas localizadas em regiões de sua preferência.
                                    As respostas auxiliarão na calibração de um modelo automático de avaliação de rotas.
                                </p>
                                <p>
                                    Os dados fornecidos neste questionário serão usados para fins de pesquisa de forma
                                    anônima, mantendo a sua privacidade e confidencialidade. Ao responder este
                                    questionário, você concorda com o uso anônimo das informações fornecidas para fins
                        ...
                        <form class="form" id="formulario_dados_pessoais">
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-12">
                                    <label class="col-form-label" for="#select_tempo"><b>Há quanto tempo você usa a
                                            bicicleta como meio de transporte?</b></label>
                                </div>
                                <div class="col-sm-12">
                            ...
                            <br>
                            <div class="row">
                                <div class="col-12"><b>Você deseja avaliar rotas de qual(is) região(ões) ?</b>
                                    <br>Para cada região selecionada, serão avaliadas 5 rotas.
                                    <br> <br>(selecione até duas)
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                <div class="col-6">
                                    <br /> <input type="checkbox" id="cb_N1" name="regiao" value="norte1">
                                    <label for="cb_N1">Norte 1</label>
                                    &nbsp;
                                    <span class="more_info" help="Anhanguera, Pirituba, Freguesia do Ó, Casa Verde">
                                    ...
                                    <br />
                                    <input type="checkbox" id="cb_N2" name="regiao" value="norte2">
                                    <label for="cb_N2">Norte 2</label>
                                    &nbsp;
                                    <span class="more_info" help="Santana, Tremembé, Vila Maria">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
                                            <path
                                                d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                    ...
                                    <input type="checkbox" id="cb_O" name="regiao" value="oeste">
                                    ...
                                    <input type="checkbox" id="cb_C" name="regiao" value="centro">
                                    ...
                                    <input type="checkbox" id="cb_L1" name="regiao" value="leste1">
                                    <label for="cb_L1">Leste 1</label>
                                    &nbsp;
                                    <span class="more_info"
                                        help="Mooca, Vila Prudente, Aricanduva, Penha, Ermelino Matarazzo">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
                                            <path
                                                d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                    ...
                                    <input type="checkbox" id="cb_L2" name="regiao" value="leste2">
                                    <label for="cb_L2">Leste 2</label>
                                    &nbsp;
                                    <span class="more_info"
                                        help="Itaquera, São Mateus, Cidade Tiradentes, São Miguel, Itaim, Guaianases">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
                                            <path
                                                d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                    ...
                                    <input type="checkbox" id="cb_S1" name="regiao" value="sul1">
                                    <label for="cb_S1">Sul 1</label>
                                    &nbsp;
                                    <span class="more_info"
                                        help="Vila Mariana, Ipiranga, Santo Amaro, Jabaquara, Cidade Ademar">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
                                            <path
                                                d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                    ...
                                    <input type="checkbox" id="cb_S2" name="regiao" value="sul2">
                                    <label for="cb_S2">Sul 2</label>
                                    &nbsp;
                                    <span class="more_info" help="Campo Limpo, Socorro,  M'Boi Mirim, Parelheiros">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
                                            <path
                                                d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                    ...
                                    <div id="validacao_regiao_2" class="invalid-feedback" style="font-size: medium;">
                                        Selecione no máximo duas regiões</div>
                                </div>
                                <div class="col-6">
                                    <img src="../images/sp_subpref_full.png" style="height: 20em;">
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="pagina" id="pagina_2">
                        <p><b>Por favor, avalie as rotas que aparecem no mapa clicando sobre elas.
                                <br>Rotas Avaliadas: <span id="avaliadas"></span>
                            </b></p>
                        <br />
                        <div class="row">
                        ...
                        <div id="avaliacao">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form action="">
                                        <p>Você faria esse trajeto de bicicleta se ele tivesse
                                            ciclovias/ciclofaixas?</p>
                                        <ul class='likert'>
                                            <li>
                                                <input type="radio" name="final_eval" value="1">
                                                <label style="color: rgb(185, 0, 0);">1<br>nunca</label>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <label style="color: rgb(0, 129, 39);">5<br>com certeza</label>
                                            </li>
                                        </ul>
                                    </form>
                                </div>
