<?php
            ...
            while (($file = readdir($dh)) !== false) {
                if($file != '.' && $file != '..') {
                    ...
                    if ($origens[$answer['origem']] != null) {
                        ...
                        echo 'acolá<br>';
                        echo $answer['origem'] . '<br>';
                        echo $origens[$answer['origem']] . '<br>';
                    }
    ...
    echo '/' .  substr($last_answer, 0, 4) . ' ';
    echo substr($last_answer, 11, 2) . ':' .  substr($last_answer, 13, 2) . '</p> <hr>';
