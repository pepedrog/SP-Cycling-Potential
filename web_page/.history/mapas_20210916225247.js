...
const span_id = document.getElementById('id_rota')
const span_dist = document.getElementById('distancia_rota')
...
function whenClicked(id, distance) {
    return function (e) {
        ...
        span_dist.style.display = 'block'

        span_id.text = id
        span_dist.text = distance
    }
}
