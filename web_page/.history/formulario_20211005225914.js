...
function hide_route_details() {
    ...
    document.getElementById('mapa').scroll({
        top: 0,
        left: 0,
        behavior: 'smooth'
    });
...
function validate_evaluation() {
    const distance = get_radio_radio('dist')
    const incl = get_radio_radio('incl')
    const final_eval = get_radio_radio('final_eval')
