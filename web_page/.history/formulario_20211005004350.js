...
function fill_ditances(trip) {
    ...
    const total = parseInt(trip.distance_0) + parseInt(trip.distance_1) + parseInt(trip.distance_2) + parseInt(trip.distance_3) + parseInt(trip.distance_4)
    dist_up.innerHTML = '&nbsp; ' + total + ' m &nbsp;'
}
