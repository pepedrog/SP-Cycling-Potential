...
*/
    plot_scatter (dist_pontentials,dist_mean_ans, 'dist_answers_chart')
    plot_scatter (incl_pontentials,incl_mean_ans, 'incl_answers_chart')
    plot_scatter (final_pontentials,final_mean_ans, 'final_answers_chart')
}
