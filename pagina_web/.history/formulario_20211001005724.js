...
function configure_form() {
    ...
    topografia.onclick = function () {
        //img_topo.style.width =      
    }
}
...
function zoom() {
    if (img_topo.style.height == table_dist.offsetHeight - 20 + "px") {
        img_topo.style.width = (mymap._container.offsetWidth - 10 - table_dist.offsetWidth ) *2+ "px"
        topografia.style.height = "100%"
        img_topo.style.height = "100%"
        topografia.style.cursor = "zoom-out"
    }
    else {
        img_topo.style.width = mymap._container.offsetWidth - 10 - table_dist.offsetWidth + "px"
        img_topo.style.height = table_dist.offsetHeight - 20 + "px"
        topografia.style.height = table_dist.offsetHeight - 20 + "px"
    }
}