...
def draw_arrow(folium_map, lat1, lon1, lat2, lon2, color='blue', weight=3, tip=6, text='', radius_fac=1.0, self_arc = False):
    """
    ...
    arc_x, arc_y, start, end = create_arc(N, RADIUS, xc, yc, [lon1, lat1], [lon2, lat2], reverse=False, self_arc=self_arc)
    arc2_x, arc2_y, start2, end2 = create_arc(N, RADIUS, xc, yc, [lon1, lat1], [lon2, lat2], reverse=True, self_arc=self_arc)
