...
document.addEventListener("DOMContentLoaded", function() {
    new_top = legend.offsetHeight - legend_img.offsetHeight
    legend.style.height = legend_img.offsetHeight + "px"
    console.log([legend.style.top, new_top])
    legend.style.top += new_top + "px"
  });
...
function configure_map() {
    ...
    legend.style.width = mymap._container.offsetWidth - 105 + "px"
}
