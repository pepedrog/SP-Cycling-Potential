<?php
    ...
    echo '<p><b>Frequência:</b><br>Diariamente: &nbsp;' . $diariamente . '<br>Frequentemente: &nbsp;';
    echo $frequentemente . '<br>Eventualmente: &nbsp;' . $eventualmente . '<br>Raramente: &nbsp;';
    echo $raramente . '<br>Nunca: &nbsp;' . $nunca .  '</p> <hr>';

    echo '<p><b>Tempo:</b></p><p><br><table><tr><td>Não usa: &nbsp;</td><td>' . $naousa . '</td></tr><tr><td>Menos de 1 ano: &nbsp;</td><td>';
