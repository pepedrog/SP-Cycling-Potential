...
function plot_scatter(x, y, title, element, 
                      range_x = [0,1.1], range_y = [0,6], 
                      title_x = 'potencial', title_y = 'respostas') {
    let trace1 = {
        x: x,
        y: y,
        mode: 'markers',
...
function plot_heatmaps() {
    ...
    /*
    plot_heatmap(dist_potentials, 'Portland', 'Potencial', 'dist_potential_chart')
    plot_heatmap(dist_mean_ans, 'Portland', 'Média das Respostas', 'dist_answers_chart')

    plot_heatmap(incl_potentials, 'Portland', 'Potencial', 'incl_potential_chart')
...
*/
    ...
    plot_scatter(final_mean_ans, dist_mean_ans, 'geral', 'dist_answers_chart', 
                 scale_x = [0,6], title_x = 'Propensão de usar a bicicleta',
                 scale_y = [0,6], title_y = 'Resposta Distância')
    plot_scatter(final_mean_ans, incl_mean_ans, 'geral', 'incl_answers_chart',  
                 scale_x = [0,6], title_x = 'Propensão de usar a bicicleta',
                 scale_y = [0,6], title_y = 'Resposta Inclinação')
