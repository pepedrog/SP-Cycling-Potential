...
function when_clicked(trip) {
    return function (e) {
        ...
        fill_ditances(trip)
        console.log(e)
        mymap.flyTo([e.latlng.lat + 0.01, e.latlng.lng + 0.03], 13, {
            animate: true,
        ...
        setTimeout(function () { 
            ...
            img_topo.style.backgroundColor='red';
            img_topo.style.width = mymap._container.offsetWidth - 75 - table_dist.offsetWidth + "px"
            img_topo.style.height = table_dist.offsetHeight - 10 + "px"
        }, 1000)
